...
import { LESSON_SESSION_SKIP_MESSAGES } from "@/features/lesson-sessions/types";
      ...
      <div className="space-y-4">
        ...
        {loading ? (
          ...
          <EmptyState
            ...
            action={
              <Button className="h-11" disabled={busy} onClick={handleRegenerate}>
                إنشاء حصص هذا اليوم
              </Button>
            }
          />
          ...
          <div className="space-y-3">
            {sessions.map((session) => (
              <LessonSessionCard
                ...
                onResetPreparation={handleReset}
