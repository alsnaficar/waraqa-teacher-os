...
import { generateSchedule, syncScheduleToDatabase } from "@/features/planner/services/planner-engine";
...
export const syncMadrasatiSchedule = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }) => {
    ...
    try {
      const calculatedEntries = await generateSchedule("لغتي الخالدة", "الصف الأول المتوسط", false);
